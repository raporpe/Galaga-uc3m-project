...
public class Constants {
	...
	public static final int[][] commanderCoordinatesLevel1 = { { BOARD_WIDTH / 2 - 10, 15 }, { BOARD_WIDTH / 2, 15 },
			{ BOARD_WIDTH / 2 + 10, 15 } };

	public static final int[][] goeiCoordinatesLevel1 = { { BOARD_WIDTH / 2 - 50, 25 }, { BOARD_WIDTH / 2 - 40, 25 },
	...
	public static final int[][] zakoCoordinatesLevel1 = { { BOARD_WIDTH / 2 - 50, 35 }, { BOARD_WIDTH / 2 - 40, 35 },
			{ BOARD_WIDTH / 2 - 30, 35 }, { BOARD_WIDTH / 2 - 20, 35 }, { BOARD_WIDTH / 2 - 10, 35 },
			{ BOARD_WIDTH / 2, 35 }, { BOARD_WIDTH / 2 + 10, 35 }, { BOARD_WIDTH / 2 + 20, 35 },
			{ BOARD_WIDTH / 2 + 30, 35 }, { BOARD_WIDTH / 2 + 40, 35 }, { BOARD_WIDTH / 2 + 50, 35 } };
	...
	public static final int[][] zakoCoordinatesLevel2 = { { BOARD_WIDTH / 2 - 50, 35 }, { BOARD_WIDTH / 2 - 40, 35 },
			{ BOARD_WIDTH / 2 - 30, 35 }, { BOARD_WIDTH / 2 - 20, 35 }, { BOARD_WIDTH / 2 - 10, 35 },
			{ BOARD_WIDTH / 2, 35 }, { BOARD_WIDTH / 2 + 10, 35 }, { BOARD_WIDTH / 2 + 20, 35 },
			{ BOARD_WIDTH / 2 + 30, 35 }, { BOARD_WIDTH / 2 + 40, 35 }, { BOARD_WIDTH / 2 + 50, 35 },
			...
			{ BOARD_WIDTH / 2 + 40, 45 }, { BOARD_WIDTH / 2 + 50, 45 } };

	// COORDINATES LEVEL 3
	public static final int[][] commanderCoordinatesLevel3 = { { BOARD_WIDTH / 2 - 50, 15 },
	...
	// AÑADIR CONSTANTS PARA SABER CUANTAS POSICIONES DISPONIBLES HAY PARA CADA
	// SPRITE Y PARA CADA NIVEL
