...
public class Constants {
	...
	// The move deltas for the directions: dX,dY}
	 ...
	 public static final int [][] enemyCoordinatesLevel1= {
			...
			{Game.BOARD_WIDTH/2-50,25},{Game.BOARD_WIDTH/2-40,25},{Game.BOARD_WIDTH/2-30,25},{Game.BOARD_WIDTH/2-20,25},{Game.BOARD_WIDTH/2-10,25},{Game.BOARD_WIDTH/2,25},{Game.BOARD_WIDTH/2+10,25},{Game.BOARD_WIDTH/2+20,25},{Game.BOARD_WIDTH/2+30,25},{Game.BOARD_WIDTH/2+40,25},
